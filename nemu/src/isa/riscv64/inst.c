...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 000 ????? 11001 11", jalr   , I, R(dest) = s->pc + 4; s->dnpc = (src1 + imm)&(~((uint64_t)(1))));
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 01110 11", sllw   , R, R(dest) = SEXT((int32_t)(BITS(src1, 31, 0)) << BITS(src2, 4, 0), 32));
  INSTPAT("0000000 ????? ????? 001 ????? 00110 11", slliw  , I, R(dest) = SEXT((int32_t)(BITS(src1, 31, 0)) << BITS(imm, 4, 0), 32));
  INSTPAT("0000000 ????? ????? 010 ????? 01100 11", slt    , R, R(dest) = (int64_t)(src1) < (int64_t)(src2));
  INSTPAT("??????? ????? ????? 010 ????? 01000 11", slti   , I, R(dest) = (int64_t)(src1) < (int64_t)(imm));
  ...
  INSTPAT("000000? ????? ????? 101 ????? 00100 11", srli   , I, R(dest) = (uint64_t)(src1) >> BITS(imm,5,0));
  INSTPAT("0000000 ????? ????? 101 ????? 01110 11", srlw   , R, R(dest) = SEXT((uint32_t)(BITS(src1, 31, 0)) >> BITS(src2, 4, 0), 32));
  INSTPAT("0000000 ????? ????? 101 ????? 00110 11", srliw  , I, R(dest) = SEXT((uint32_t)(BITS(src1, 31, 0)) >> BITS(imm, 4, 0), 32));
  ...
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, R(dest) = (uint64_t)(src1) / (uint64_t)(imm));
  ...
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, R(dest) = (uint64_t)(src1) % (uint64_t)(imm));
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(dest) = BITS((__int128)(src1)*(__int128)(src2),127,64));
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, R(dest) = BITS((__int128)(src1)*(__uint128_t)(src2),127,64));
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, R(dest) = BITS((__uint128_t)(src1)*(__uint128_t)(src2),127,64));  
